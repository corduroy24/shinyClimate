...
plot <- function(input, output, session, sb_vars, options) {
  ...
  observe({
    ...
    if(options == "Histogram - Slopes - National"){
    ...
    else if(options == "Histogram - R-Squared for Slopes - National"){
    ...
    else if(options == "Boxplot - Slopes - National/Provincial"){
    ...
    else if(options == "Histogram - Slopes - Provincial"){
    ...
    else if(options == "Boxplot - R-Squared for Slopes - National/Provincial"){
    ...
    else if(options == "Histogram - CI_lower for Slopes - National"){
    ...
    else if(options == "Histogram - CI_upper for Slopes - National"){
